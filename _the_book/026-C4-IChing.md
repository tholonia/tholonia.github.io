...
series: 1
chapter_title: 'Appendix C4: Tholonic Recursion and the I Ching'
chapter_file: 026-C4-IChing.md
version: 8.0.89
status: 'Updated: Mar 26, 2026 v8.0.89'
subject: philosphy, geometry, mathematics, physics, consciousness, energy, chaos, order, reason, creation, evolution, I Ching, hexagrams, binary, Leibniz, tholonic recursion, Growth, Perfection, Refinement, Path of Equilibrium, The Passage, Peace, Standstill, Middle Way
image: /the_book/assets/chapters/images/026-C4-IChing.jpg
---

<div style='page-break-after: always; break-after: always;'></div>

# Appendix C4: Tholonic Recursion and the I Ching

###### Ancient binary wisdom and modern tholonic mathematics

##### **Synopsis:** The binary nature of tholonic recursion connects naturally to the I Ching, which Leibniz himself recognised as a mirror of his independently developed binary arithmetic.  The 64 hexagrams map precisely onto the three tholonic axes — Growth (Increase–Duration), Perfection (Before Completion–After Completion), and Refinement (Decrease–Influence) — with each axis dividing the hexagrams into symmetrical segments.  The central concept of the Path of Equilibrium (*The Passage*) is shown to reflect universal philosophical traditions from Buddhism's Middle Way to Taoism's wu-wei, and is embodied in the hexagram pair Peace and Standstill.  This appendix should be read alongside the companion volumes *Introduction to the Tholonic I Ching* and *The Tholonic I Ching*.

##### **Keywords:** I Ching, hexagrams, binary, Leibniz, tholonic recursion, Growth, Perfection, Refinement, Path of Equilibrium, The Passage, Peace, Standstill, Middle Way
