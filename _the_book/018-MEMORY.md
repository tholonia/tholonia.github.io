...
chapter_file: 018-MEMORY.md
version: 8.0.89
status: 'Updated: Mar 26, 2026 v8.0.89'
subject: philosphy, geometry, mathematics, physics, consciousness, energy, chaos, order, reason, creation, evolution, reality, quantum Darwinism, tholonic paths, hidden data, Brownian motion, archetypes, time dilation, gravity, relativity
image: /the_book/assets/chapters/images/018-MEMORY.jpg
---

<div style='page-break-after: always; break-after: always;'></div>
# 18: MEMORY

###### Reality is the living memory of what works
##### **Synopsis:** Reality itself is the field-memory of all tholonic patterns that have proven sustainable.  Quantum Darwinism explains how successful states decohere into what we experience as reality.  Tholonic paths encode the entire lineage of a pattern from creation to its present instance.  Information is embedded in waves and recoverable through proper decoding.  Brownian motion describes how tholonic archetypes progress through time.  Gravity, consciousness, and time-dilation are explored as instances of the same underlying tholonic pattern, with relative archetypes demonstrating how context shapes causality.

##### **Keywords:** reality, quantum Darwinism, tholonic paths, hidden data, Brownian motion, archetypes, time dilation, gravity, consciousness, relativity

Chapter 17 closed by asking where exactly field information is stored, and identified dark matter, engrams, collective memory, modulation, and structured memory as candidates.  This chapter examines the most promising of those candidates in detail, and then asks whether the question itself needs reframing: rather than asking where tholonic memory is stored, perhaps the better question is what reality actually is.

## Dark-Matter

One candidate is dark-energy/dark-matter.

Before I describe this idea, I want to make it clear that I am not a cosmologist, physicist, or scientist of any kind, so this idea may be ridiculously naive and laughable to anyone knowledgeable about the subject.  That said, let’s give it a whirl.

Dark energy occupies 70% of the known Universe, cannot be directly observed, and emits no light or energy.  Dark matter occupies another 25%, and the measly remaining 5% is the matter we can see.  Dark matter can have dark electrons and dark protons, and there is even dark chemistry (and maybe dark-tholons, like the virtual ones?).  Dark energy also produces dark electromagnetism and dark electricity.  Dark matter does not interact with “regular” matter.  In fact, there are (believed to be) dark galaxies, which are galaxies of dark-energy/matter superimposed on a galaxy of “regular” energy/matter.  In short, everything that exists has a “dark” clone that we can’t detect.  What better medium than dark energy is there for collecting information across every scale of reality?

Dark matter/energy is not just some weird thing we guess is there.  Evidence suggests it forms the structure of the entire Universe.  Still, all we really know about dark matter is that it exists, exists everywhere, and interacts with gravity, one of the 4 fundamental forces of energy.  This makes gravity the nominee for how the information is transmitted between dark energy and the “regular” energy of our reality.  Perhaps some form of entanglement is involved in dark energy, allowing information to travel faster than the speed of light.  

Dark energy is quite elusive, as we can’t detect it or measure it. Still, we can see its effects in the expanding Universe, as dark energy seems to be continually created (like some dynamic memory system that keeps expanding to accommodate the exponentially increasing storage requirements of the Universe?).  Perhaps there is a relationship between extrasensory phenomena and dark matter or energy?

Has anyone tested this? I have scoured the Internet for such research and found nothing.  However, I did run across this very interesting post from one of the senior members of Cambridge University’s Institute of Continuing Education, who posted the following:

> Subject: Can quantum dark-energy explain telepathy?
>
> Telepathy and quantum entanglement seem to match each other in that a communication connection exists, but no tangible connection.  Could there be a hitherto unknown dark-energy particle produced by electrical impulses in the brain? Could entangled particles of this dark energy be shared? If a plasmon circuit in the brain creates patterns of these dark matter particles, based on thoughts and ideas, do people with the shared particles share the same patterns of thoughts and ideas? How long-lived are these particles? How long do they maintain patterns, and what might be the mechanism for transfer? These particles may be exchanged through quantum molecular tunneling, allowing a brain to transmit them outside the head and a person with a corollary quantum molecular tunnel to receive them readily.  Persons sharing close, personal space may be more likely to transfer these particles to one another, such as twins, relatives, friends, and even enemies.  It may be that these particles are long-lasting, which could allow objects to be imbued with dark particle patterns, enabling a sensitive to read a person through the object.  It may be that wherever a transmitter goes, the location they were at is imbued with the thought patterns of their experiences.  The implications of such a mechanism for telepathy imply that electronics may amplify this process to increase the strength of transmission and reception.  It also implies that we could control electronics through telepathy.[^146]
...
This theory is not mere speculation.  Vopson has performed tests that anyone (with the proper equipment) can replicate.  And what do the tests show?  Information has a tiny, tiny amount of mass: 2.91 × 10<sup>-40</sup> Kg/bit, exactly.  Applying that value to the size of DM in the Universe results in 2.59 × 10<sup>82</sup> bits of information.  This is quite close to the 10<sup>82</sup> atoms in the Universe, as mentioned earlier.
...
Gravity and consciousness both exist as fields, and both are fundamental to existence.  If we accept the theory of the Big Bang that mass was created by the infinite gravity of the 0-dimensional singularity, then gravity may be the first instance of A&I that created matter.  As gravity is concentrated via matter, what is it that concentrates consciousness in our material reality? As matter is an instance of energy, could energy be an instance of Awareness?  

Considering that gravity and awareness are both ubiquitous fields that create and bind the entire Universe, they seem like excellent candidates for exploring field memory.
...
For the question at hand, what this means is that if there is such a thing as a universal data-store of all the instances of Awareness, then we will find clues to its existence in the differentiation of, or relationships between, instances of consciousness and mass.

This attempt to quantify consciousness and awareness may sound very esoteric or even ridiculous to some. Still, growing evidence suggests that consciousness is a force of nature and, as such, has quantifiable properties.
...
> Thus, we can use the term “conscious force” for gravitational force&hellip;  ***Conscious force* is gravitational force**, which is the unidentified 5<sup>th</sup> force.  This force is a synonym for gravitational force and works just like it on all matter, irrespective of their nature or position in space, both in the macro and micro worlds.

If Awareness and its instances of consciousness are fundamental forces, then they have a field. Could that field hold clues to *field memory*, similar to how the memory in the brain might be a *neuronal activity-associated magnetic field*? [^149]<sup>,</sup>[^150] In any case, there seems to be a strong correlation between consciousness, gravity, dark matter, and information.
...
This is very related to the information/dark matter section above.  This idea is based on Quantum Darwinism[^157], which states that, among all the possible states, those that survive do so because of support from their environment.  In turn, these states that survive transfer information to the environment, altering its context and shifting the curve in its favor, thereby improving the probabilities of future similar states.
...
As energy interacts with its environment, the range of probabilities for the many attributes of an energy particle begins to decohere, or disappear, leaving only the attributes most compatible with the environment, which then interacts with the environment to make it more compatible with those attributes.  Notice the compatibility of Quantum Darwinism with the descriptions of the social equations in the section “The Meaning of Math” in Chapter 14, “*Applications*”, and how quantum Darwinism is a perfect example of context&rightarrow; content &rightarrow;context&rightarrow; etc.
...
The peak of the Bell curve tells us the most likely result: we will get heads 16 out of 32 flips, on average.  We have decided to run this test 5 times, but each subsequent time we will only use the coins that came up heads in the previous test.  We end up with the following:
...
So, when we run these 5 tests 50,000 times each, the chance of ending up with 1 coin out of 32 is obviously 100%.
...
If an observer were blind to the process and only knew that the final result was one penny but that you started with 62 coins, they would say there is a 2:62, or 3.2% chance of you ending up with a penny, when, in fact, you know there is a 100% chance of you ending up with a penny.  That’s a 96.8% margin of error vs. 0%. 

The observer, in an attempt to replicate your success but not knowing your process, will begin running tests and keeping notes on what worked and what didn’t.  He checks these notes every time he runs a new test to ensure he is not doing something that has been shown to fail.  Once he discovers your process, he can archive the failed notes and describe the method that worked.  He does not need to record all the failures once he has discovered the process that works, but he does to pass them on to the next generation of researchers who will approach similar problems in the same bottom-up fashion.

Existence does not need to record its failures as it is the ultimate top-down approach from the tholonic perspective.  From the first instance of creation, nothing progressed unless the previous process worked; i.e., new child tholons are created only from the stable patterns of the parent tholon.  No reverse engineering is necessary for existence, as it is an exclusively forward-engineering process.  If a branch of existence fails, it will only fail up to the last successful parent.  This is like saying that if all your nickels were swapped out for double-tailed nickels, then all flips after the nickels would come up as zero, killing the entire branch below nickels and preventing any opportunity for the dimes, half-dollars, and pennies.  The quarters are still fine, and since you want the tests to keep working correctly, you need to get new nickels to fix the problem.
...
In this example of an experiment, or any experiment for that matter, from the tholonic view, both the experiment and the experimenter are an integral part of the tholonic expression.  There is no data without the experimenter and the observer; if there is no data, then there is no instance, only an archetype.

<img src='../Images/102-tpaths.png' style='float: right;width:40%'/>A simple example more aligned to the tholonic model would be how N-states emerge along the Bell curves from which N-sources create new trigrams.  This idea is shown in the image on the right using a Fourier Series of hierarchical circles.  By assigning a point value on the spectrum and a binary value indicating the trigram's generation, we can create a unique value for each point that identifies its position on the spectrum and its level.  If we combine these numbers, we can create a single value for the entire lineage, with an extractable record of the chain of tholons and their spectra at every level.  This value would then serve as a record of all ancestors.  We can see this easily in simple binary math.  If we have 5 generations of numbers that double with each generation, such as 1,2,4,8,16, and we have the number 22 representing the sum of all the contributing generations, we can easily determine that only the 2<sup>nd</sup>, 3<sup>rd</sup> and 5<sup>th</sup> generations contributed, because only 2, 4, and 16 can create 22.  The tholons are similar in that each tholon has a fingerprint, encoded in every descendant, that describes its path from the source.

This means that everything that exists is *already* a record of what works from the 1<sup>st</sup> moment of creation, through every generation, up to and including the thing that exists.  Life, Reality, and Everything *is* the warehouse of all knowledge.  We just haven’t figured out how to decode (most of) it yet.  We demonstrated an example of the binary qualities of tholonic counting earlier (the companion book “*The Tholonic I-Ching*” specifically addresses this and shows precisely how each tholon has a naturally existing binary signature).  It may actually be that a thing itself ***is*** the value of that tholon.  

We use numbers as data because they allow us to map a thing to the perfectly non-chaotic, abstracted data matrix, which in turn allows us to find patterns of order. Still, it's useful to remember that a *thing* is an ever changing instance of archetypes in a single moment.

### Hidden Data
<img src='../Images/wavetypes2.png' style='float: right;width:25%'/>This is similar in concept to the way a piece of music is the combination of many *atoms* of sound (yes, that’s a real thing, and it’s about 0.093 seconds[^158]), each an aggregate of many individual frequencies.  Over time, these frequencies change, resulting in “music” because we can “decode” those frequencies, thanks to the cooperative functions of our auditory cortex, cerebrum, cerebellum, and limbic system.  We can also decode waves using concepts such as the Fourier Transform, which allows us to discover all of a wave’s components, but that does not mean we can recognize the information it contains.  For example, there can be images encoded in frequencies that no analysis will discover unless we know what to look for, such as the image of Barack Obama encoded into sound (Image right.  For more examples, see *Appendix E*, “*Hidden Images*”)
...
Just for fun, here is the human eye made only from images from this book, and a bull skull in Death Valley adorned with blooming flowers.

<center><img src="../Images/mosaic-eye.png" style="width:100%"/></center>

### Brownian Archetypes

These images are meant to demonstrate how information can be composed of information and how any one piece of information is composed of smaller pieces and part of a larger piece.  So, how can we even begin to decode such information?  One thing we can do is look at how information “progresses”.  The multiple generations of embedded images, tholons, or fractal patterns represent unique paths, or lineages, that start from one point and end at many points.  The progression of these lineages is neither predictable nor random.  They are the result of expanding energy moving forward in time, diverging from one archetype and converging on others, not unlike Brownian motion (examples shown below).

<center><img src='../Images/brownian.png' style='width:100%'/></center>

This claim is based on the fact that Brownian and Fractional Brownian Motion (FBM) are archetypes for, and can describe,  rivers [^352]<sup>,</sup>[^353], trees[^354], neurology[^355], landscapes, and appear to be fundamental to all organic growth.
...
Now, if we extend a cube into the 4<sup>th</sup> dimension, we end up with 8 cubes, but 6 of those cubes require the 4<sup>th</sup> dimension to exist, leaving 2 cubes that can be expressed in 3 dimensions (right image bottom).  Therefore, in the 3D world, a 4D cube would appear as 2 separate 3D cubes.  Tweak the 4D cube, and both 3D cubes will change simultaneously.  Tweak either of the 3D cubes, and you effectively tweak the 4D cube, which in turn tweaks the other 3D cube.
...
Why did it take 6 hours and 28 min to watch your friend’s laser light move 1 light-second? When we say “5 minutes is 5 minutes,” we assume there is no time dilation difference between any set of 5 minutes. Still, there is time dilation in our perception, our consciousness of those 5 minutes, which we can’t disregard, considering that were it not for our consciousness, we wouldn’t be looking at anything.  Our perception of time doesn’t change the clock’s mechanics on the wall any more than looking at a tree will alter how your television works.  Still, the clock on the wall is measuring a particular form of objective time in an extremely limited context.

It’s been proven many times over in the past 100 years that time is relative, so there is no objective standard for time.  We use atoms to get precise timings for clocks, but even these atoms don’t agree with each other unless they are at the same altitude and in the same location.  An atomic clock in Peru ticks more slowly than one in the Arctic because gravity is stronger there.  So, we put an atomic clock in Boulder, Colorado, and say, “This is the official time”, and then go to great lengths to make all the clocks agree with that; satellites, communications, and navigation would be a complete mess.  This is why satellite timekeeping has to be updated every 12.5 minutes.  Anything that needs to be adjusted 42,048 times a year to work properly can hardly be called an objective standard of measure or accuracy.  And even with this atomic clock in Boulder, the time dilation in the Universe is constantly changing due to the Universal expansion, so 5 minutes today is not the same as 5 minutes tomorrow, even though it *appears* the same to us because we are also changing with the expansion. 
...
What this chapter has established is that memory is not a biological accident confined to brains.  Dark matter encodes the entire informational history of the universe.  Quantum Darwinism filters the successful states of energy into what we experience as physical reality, making reality itself the living record of what has worked.  Tholonic paths carry the complete lineage of every pattern from its first instantiation to its current expression.  Information is embedded in the structure of waves and recoverable through appropriate decoding.  Gravity and consciousness, examined together, reveal themselves as two instances of the same underlying tholonic pattern: the tendency of awareness to impose structure on its context.  And time, far from being the fixed backdrop against which events occur, is itself a product of interaction, shaped by gravity and movement and dilated by the very consciousness that perceives it.

All of this converges on a single question that the chapter has been circling from its first paragraph: if the universe encodes, stores, and transmits the memory of everything that has worked, what is the mechanism by which a particular tholon draws on that memory and translates it into directed action?  The answer is intention, and it is the subject of Chapter 19.
