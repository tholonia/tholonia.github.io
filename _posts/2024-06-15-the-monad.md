...
<audio controls>
  <source src="/assets/posts/2024-06-15-the-monad/The_Monad_CAI_ch_1.mp3" type="audio/mp3">
  Your browser does not support the audio element.
</audio>

<sup>(Note: Notebook LM, an experimental AI-powered note-taking application, is a very impressive technology, the output misses the mark, at least for this content. It also sounds like two talking heads from "Good Morning America" 😬)<sup>
